...
#SBATCH --gres=gpu:4
#SBATCH -c 32
#SBATCH --output="dtu_optim_logs/split16_dtu_scan65-%j.log"
#SBATCH --open-mode=append

scene='split16_dtu_scan65'
gpus='0,1,2,3'
model='nerfactor'
overwrite='True'
...
surf_root="/export/work/sanskara/svbrdf/nerfactor_dtu/output/train/$scene"

# shape_outdir="/export/work/sanskara/svbrdf/nerfactor/output_new/train/${scene}_shape"
shape_outdir="/export/work/sanskara/svbrdf/nerfactor_dtu/output/train/${scene}_shape"
...
outroot="/export/work/sanskara/svbrdf/nerfactor_dtu/output/train/${scene}_$model"
