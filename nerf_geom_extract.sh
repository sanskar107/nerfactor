#!/bin/bash
#SBATCH --job-name=ant_nerf_geom
#SBATCH -p g24
#SBATCH --qos=low
#SBATCH --ntasks=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --output="dtu_nerf_geom_logs/antman1/job-%a-%j.log"
#SBATCH --open-mode=append
#SBATCH --array="0-44"

scene='antman1'
# mkdir -p dtu_nerf_geom_logs/"$scene"
gpus='0'
...
trained_nerf="/export/work/sanskara/svbrdf/nerfactor_dtu/output/train/${scene}_nerf/lr$lr"
occu_thres='0.5'
...
count=$(python get_count_dtu.py "$scene")
...
out_root="/export/work/sanskara/svbrdf/nerfactor_dtu/output/train/$scene"
